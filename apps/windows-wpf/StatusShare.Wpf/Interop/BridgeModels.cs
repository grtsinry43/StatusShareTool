...
public sealed class MediaInfoDto { public string Title { get; set; } = string.Empty; public string Artist { get; set; } = string.Empty; public string Thumbnail { get; set; } = string.Empty; public double Position { get; set; } public double Duration { get; set; } public string State { get; set; } = string.Empty; }
public sealed class GameMetaDto { public string Name { get; set; } = string.Empty; public string Cover { get; set; } = string.Empty; public string Slogan { get; set; } = string.Empty; public string Desc { get; set; } = string.Empty; public string Accent { get; set; } = string.Empty; public string Url { get; set; } = string.Empty; }
...
public sealed class StatusUpdateDto { public int? Ok { get; set; } public string? Process { get; set; } public string? Extend { get; set; } public string? Category { get; set; } public GameMetaDto? Game { get; set; } public MediaInfoDto? Media { get; set; } public long? Timestamp { get; set; } }
public sealed class ResolveStatusResultDto { public bool ShouldReport { get; set; } public string MatchedRuleId { get; set; } = string.Empty; public string Process { get; set; } = string.Empty; public string Extend { get; set; } = string.Empty; public string Category { get; set; } = string.Empty; public GameMetaDto? Game { get; set; } public MediaInfoDto? Media { get; set; } public StatusUpdateDto? Update { get; set; } public string ErrorMessage { get; set; } = string.Empty; }
public sealed class StatusSnapshotDto { public int Ok { get; set; } public string Process { get; set; } = string.Empty; public string Extend { get; set; } = string.Empty; public string Category { get; set; } = string.Empty; public GameMetaDto? Game { get; set; } public MediaInfoDto? Media { get; set; } public long Timestamp { get; set; } public bool AdminPanelOnline { get; set; } }
